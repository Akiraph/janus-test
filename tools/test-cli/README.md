...
`janus-test` is Janus's black-box verification entry point. It connects to a running service and uses public HTTP, SSE, and WebSocket interfaces to check health, resource changes, errors, and recovery. It does not open SQLite or call Rust internals.
