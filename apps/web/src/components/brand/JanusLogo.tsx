...
/**
 * Janus logo — minimal geometric "J" in the light border accent.
 * Simple, modern, scalable SVG.
 */
export function JanusLogo({ className, size = 32 }: Props) {
  return (
    <svg
      width={size}
      height={size}
      ...
      aria-label="Janus"
    >
      {/* Stylized "J" using the light border accent. */}
      <path
