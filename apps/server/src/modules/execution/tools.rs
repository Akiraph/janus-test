...
use janus_workspace::path::PathError;
...
pub struct ToolContext<'a> {
    ...
    pub runtime: &'a crate::modules::runtime::interface::RuntimeInterface,
...
async fn ensure_session_runtime(
    ctx: &ToolContext<'_>,
) -> Result<crate::modules::runtime::interface::RuntimeProjection, ExecutionError> {
...
fn working_directory(
    input: &Value,
) -> Result<crate::modules::runtime::interface::RelativeWorkingDirectory, ExecutionError> {
